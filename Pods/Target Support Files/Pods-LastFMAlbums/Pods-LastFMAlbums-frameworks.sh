...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Moya-iOS12.1/Moya.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ObjectMapper-iOS12.1/ObjectMapper.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Result-iOS12.1/Result.framework"
